...
import ChatBotCardImg from "../../assets/Chat-bot-bro.png";
      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              ChatSphere is a Open AI powered chat bot based on
              text-davinci-003 that leverages the capabilities of GPT-4,
        ...
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              ChatSphere is a conversational AI chatbot designed to engage in
        ...
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              ChatSphere is also accompanied by a clean and responsive user
